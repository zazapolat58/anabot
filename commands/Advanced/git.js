...
if (message.member.permissions.has("ADMINISTRATOR")) {
    ...
    message.react("<a:ozi_onay:851064010497720350>")
...
await question.react("<a:ozi_onay:851064010497720350>");
await question.react("<a:ozi_iptal:851064489355771914>");
const answer = await question.awaitReactions((reaction, user) => ["<a:ozi_onay:851064010497720350>", "<a:ozi_iptal:851064489355771914>"].includes(reaction.emoji.toString()) && user.id === member.user.id, { max: 1, time: 60000, errors: ["time"] }).catch(() => { question.edit(embed.setDescription("İşlem iptal edildi!")) });
if (answer.first().emoji.toString() === "<a:ozi_onay:851064010497720350>") {
