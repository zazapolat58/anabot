...
class AFK extends Command {
    ...
    async run(message, args, data) {
        ...
        if (message.content.includes("@here") || message.content.includes("@everyone") || message.content.includes("<@&834131614304567337>") || message.content.includes("834131614304567337")) return
