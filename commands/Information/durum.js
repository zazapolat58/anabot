...
class Durum extends Command {
    ...
    async run(message, args, data) {
        ...
        let rol = message.guild.roles.cache.find(x => x.name == "People of Shéw").members.size
        ...
        message.channel.send("**Shéw #1404** " + members + " toplam üyeye sahip. %" + parseInt(((members - rol) / members) * 100) + " kayıtlı, %" + parseInt((rol / members) * 100) + " kayıtsız, %" + parseInt((online / members) * 100) + " çevrim içi ve %" + parseInt((tag / members) * 100) + " taglı.");
