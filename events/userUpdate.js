...
module.exports = class {
  ...
  if (!eski.username.includes(tag) && yeni.username.includes(tag)) {
    ...
    üye.send(`Hey Selam! Tagımızı alıp ailemize katıldığın için sana Taglı Rolünü verdim. Tekrardan ailemize hoş geldin!`).catch(e => {});
    ...
    üye.send(`Hey Selam! Tagımızı çıkardığın için senden Taglı Rolünü aldım. Tekrardan ailemize katılmak istersen tagımız. \`${Guild.Tag}\``).catch(e => {});
